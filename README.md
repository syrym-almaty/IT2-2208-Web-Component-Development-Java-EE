...
## Welcome to the IT2-2208 Web Component Development project! Follow the instructions below to clone the repository, set up your environment, and start developing
...
cd IT2-2208-Web-Component-Development-Java-EE
```
...
git remote set-url origin git@github.com:syrym-almaty/IT2-2208-Web-Component-Development-Java-EE.git
...
git remote add origin git@github.com:syrym-almaty/IT2-2208-Web-Component-Development-Java-EE.git
